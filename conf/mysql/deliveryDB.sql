...
CREATE TABLE `client` (
  ...
  KEY `client_coordinates_id_fk` (`coordinates_id`),
  CONSTRAINT `client_coordinates_id_fk` FOREIGN KEY (`coordinates_id`) REFERENCES `coordinates` (`id`) ON DELETE CASCADE
...
-- Dump completed on 2022-01-28 18:29:33
